...
export function createMobileRedirectResponse(deepLink) {
  ...
  return new Response(
    ...
    <html>
      <head>
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <title>Opening MDX Billing...</title>
        <script>
      ...
      <body>
        <main>
          <h1>Opening MDX Billing...</h1>
          <p>If Chrome does not return automatically, use the link below.</p>
          <a href="${safeLink}">Open MDX Billing</a>
        </main>
      </body>
    </html>`,
    {
...
export async function GET(request) {
  ...
  return createMobileRedirectResponse(redirectUrl.toString());
}
