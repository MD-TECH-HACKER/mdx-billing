...
echo   ║   ─────────────────────────────────────────────────      ║
echo   ║                                                          ║
echo   ║   [2]  📦  BUILD (Obfuscated)   Production bundle        ║
echo   ║        └─  React Router Build + Production JS Obfuscation║
echo   ║                                                          ║
echo   ║   [3]  ⚡  BUILD FAST           No obfuscation           ║
echo   ║        └─  React Router Build only                       ║
echo   ║                                                          ║
echo   ║   ─────────────────────────────────────────────────      ║
echo   ║                                                          ║
echo   ║   [4]  🌐  PRODUCTION DEPLOY    npm start (port 8080)    ║
echo   ║        └─  Serve the production bundle locally           ║
echo   ║                                                          ║
echo   ║   ─────────────────────────────────────────────────      ║
echo   ║                                                          ║
echo   ║   [5]  ☁️  CLOUDFLARE           Install/Start/Restart    ║
echo   ║        └─  Cloudflare Tunnel management                  ║
echo   ║                                                          ║
echo   ║   ─────────────────────────────────────────────────      ║
echo   ║                                                          ║
echo   ║   [6]  🛑  KILL ALL             Stop every service       ║
...
echo.
echo   ╔══════════════════════════════════════════════════════════╗
echo   ║            ⚡  BUILDING FAST (no obfuscation)            ║
echo   ╚══════════════════════════════════════════════════════════╝
echo.
cd /d "%WEB_DIR%"
...
echo.
echo   ╔══════════════════════════════════════════════════════════╗
echo   ║          ⚡  FAST BUILD COMPLETE! (not obfuscated)       ║
echo   ║   📁 Output : build\                                     ║
echo   ║   👉 Run option [4] to deploy to production.             ║
echo   ╚══════════════════════════════════════════════════════════╝
echo.
...
if not exist "build\server\index.js" (
    echo   ❌ No build found! Run option [2] or [3] first.
    echo.
    pause
    goto MENU
)

echo   ✅ Build verified (build\server\index.js exists)
echo.
...
echo.
echo   ╔══════════════════════════════════════════════════════════╗
echo   ║        ☁️  CLOUDFLARE TUNNEL — Control Panel            ║
echo   ╠══════════════════════════════════════════════════════════╣
echo   ║                                                          ║
...
if "%cf_choice%"=="1" (
    ...
    echo.
    echo   ✅ Cloudflare Tunnel installed as Windows service.
    echo.
    pause
...
if "%cf_choice%"=="5" (
    ...
    echo   ✅ Cloudflare Tunnel uninstalled.
    echo.
    pause
    goto CLOUDFLARE_MENU
)
if "%cf_choice%"=="6" (
    ...
    if %errorlevel% neq 0 (
        echo   ℹ️  cloudflared service is NOT installed.
    )
    echo.
...
if %errorlevel% equ 0 (
    ...
    echo   ℹ️  Cloudflare service not active or not installed.
)
echo.
