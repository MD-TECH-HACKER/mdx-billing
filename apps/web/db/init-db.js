...
async function init() {
  ...
  await sql`
    CREATE TABLE IF NOT EXISTS shops (
      ...
      accent_color TEXT,
      gstin TEXT,
      default_invoice_type TEXT DEFAULT 'tax_invoice',
      default_payment_method TEXT DEFAULT 'cash',
      default_terms TEXT,
      receipt_size TEXT DEFAULT 'a4',
      print_mode TEXT DEFAULT 'color',
  ...
  await sql`
    CREATE TABLE IF NOT EXISTS products (
      ...
      opening_stock_base_unit NUMERIC,
      stock_base_unit NUMERIC,
      sold_base_unit NUMERIC DEFAULT 0,
      reorder_level NUMERIC DEFAULT 5,
      low_stock_base_unit NUMERIC,
      hsn_sac TEXT,
